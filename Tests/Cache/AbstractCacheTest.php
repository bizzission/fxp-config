...
namespace Fxp\Component\Config\Tests\Cache;

use Fxp\Component\Config\ConfigCollectionInterface;
use Fxp\Component\Config\Tests\Fixtures\Cache\MockCache;
...
final class AbstractCacheTest extends TestCase
{
    ...
    {
        $this->cacheDir = sys_get_temp_dir().'/fxp_security_abstract_cache_test';
    }
